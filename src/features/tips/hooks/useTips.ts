...
const useTips = () => {
  ...
  const getTips = useCallback(() => {
    const hurtTips = t('tips:hurt', {returnObjects: true}) as TipTranslation[];
    const hungerTips = t('tips:hunger', {
      returnObjects: true,
    }) as TipTranslation[];
    const hydrationTips = t('tips:hydration', {
      returnObjects: true,
    }) as TipTranslation[];
    const hygieneTips = t('tips:hygiene', {
      returnObjects: true,
    }) as TipTranslation[];
    const happinessTips = t('tips:happiness', {
      returnObjects: true,
    }) as TipTranslation[];
    const mobilityTips = t('tips:mobility', {
      returnObjects: true,
    }) as TipTranslation[];
    const encouragementTips = t('tips:encouragement', {
      returnObjects: true,
    }) as TipTranslation[];
